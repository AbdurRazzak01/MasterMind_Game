	...
	public static void main(String[] args) {
		...
		do{ 
			...
			while (guess_count<guess_number ) {
				...
				guess_count++;
				CalculateScore.DisplaySymbols(GuessColour, SecretColour);
			...
			CalculateScore.MastermindScore(GuessColour, SecretColour, code_size, guess_number, guess_count, score, correct_code);
